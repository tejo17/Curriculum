    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content" >
            <div class="modal-header">
             ...
             <h4 class="modal-title h4,responsive" style="text-align:center; clear:both"><i class="material-icons prefix">account_circle</i>Ciclo Y Carreras Univeristarias</h4>
         </div>
         <div class="modal-body">
            <div class="row">
                <form class="col-md-12" method="POST" action="educationsFormations">
                    ...
                    <div class='switch'>
                        <label>Ciclo
                            <input type='checkbox' class='checkcycle' name='carrera' id="carrera">
                            <span class='lever'>
                            </span>Carrera
                        </label>
                    </div>
