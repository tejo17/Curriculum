                        ...
                        <form action="otherGrades" method="POST" class="col-md-12">
                            ...
                            <i class="material-icons prefix">schedule</i>
                             ...
                             <div class="input-field col-md-12">
                                ...
                                {{ Form::textarea('descriptionGrade', null, ['class' => 'form-control', 'id' => 'description', 'maxlength' => '250', 'style' => 'border:1px lightgrey solid; padding-left:10px; padding-top:10px;', 'rows' => '5']) }}
